...
# Terser 的 `/*#__PURE__*/` 注释

首先明确一下，`/*#__PURE__*/` 注释是来自 [Terser](https://terser.org/) 的。Webpack 有一个名叫 [“TreeShaking”](https://webpack.docschina.org/guides/tree-shaking/) 的功能，它可以分析并在打包时删除没有使用到的代码，这个过程就是由 Terser 来进行的，因此此注释实际上是给 Terser使用的。
