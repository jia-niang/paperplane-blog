...
可以 [点此链接](https://git.paperplane.cc/chiskat/paperplane-blog/src/branch/master/themes/landscape/source/css/_partial/article.styl) 查看本博客正文部分的样式修复代码。
...
你可以在 [这里](https://git.paperplane.cc/chiskat/paperplane-blog/src/branch/master/scripts/hexo-deployer-s3/hexo-deployer-s3.js) 找到博客源码中上传 S3 的插件代码，源自 GitHub 上的某个插件，我为它更换了最新的 S3 SDK，提供了跳过 HTML、跳过字体文件等配置项。另外也可以通过 CI/CD 来完成上传 S3，但我考虑到灵活度这一问题，没有使用 CI/CD 来做上传操作。
...
可以 [点此前往](https://git.paperplane.cc/chiskat/paperplane-blog/src/branch/master/scripts/hexo-post-history/hexo-post-history.js) 插件代码页面。
...
可以 [点此前往](https://git.paperplane.cc/chiskat/paperplane-blog/src/branch/master/scripts/hexo-short-url/hexo-short-url.js) 插件代码页面。
